...
const quantities: Record<string, Quantity[]> = {
	...
	currency: [
		...
		{ name: 'US Dollar :flag_us:', value: 0.91, short: ['USD', '$'], },
		{ name: 'pound sterling :flag_gb:', value: 1.15, short: ['GBP', '£'] },
		{ name: 'Turkish Lira :flag_tr:', value: 0.047, short: ['TRY', 'TL', '₺'] },
		{ name: 'Russian Ruble :flag_ru:', value: 0.012, short: ['RUB', '₽'] },
		{ name: 'Canadian Dollar :flag_ca:', value: 0.68, short: ['CAD'] },
		{ name: 'Australian Dollar :flag_au:', value: 0.62, short: ['AUD'] },
		{ name: 'Japanese Yen :flag_jp:', value: 0.0067, short: ['JPY', '¥', 'yen', 'jy'] },
		{ name: 'New Zealand Dollar :flag_nz:', value: 0.58, short: ['NZD'] },
		{ name: 'Indonesian Rupiah :flag_id:', value: 0.000062, short: ['IDR', 'Rp'] },
		...
		{ name: 'Icelandic króna :flag_is:', value: 0.0066, short: ['ISK'] },
		{ name: 'Czech koruna :flag_cz:', value: 0.043, short: ['CZK', 'Kč'] },
		{ name: 'Swiss franc :flag_sw:', value: 1.02, short: ['CFH', 'fr'] },
		...
		{ name: 'Sri Lankan Rupee :flag_lk:', value: 0.0028, short: ['LKR', 'රු', 'ரூ'] },
		{ name: 'Hungarian Forint :flag_hu:', value: 0.0027, short: ['HUF'] },
