...
module.exports = {
	run: (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(client.config.mainServer.roles.loa)) {
            ...
            setTimeout(() => interaction.member.setNickname(`[LOA] ${interaction.member.nickname}`), 1000);
            ...
            setTimeout(() => interaction.member.setNickname(`${interaction.member.nickname.replaceAll('[LOA] ', '')}`), 1000);
