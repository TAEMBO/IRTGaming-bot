...
module.exports = {
  run: (client, interaction) => {
    ...
    client.channels.cache.get(client.config.mainServer.channels.modlogs).send(`**Restart issued by ${interaction.user.tag}** \`${interaction.user.id}\``).then(async ()=> eval(process.exit(-1)))
  },
