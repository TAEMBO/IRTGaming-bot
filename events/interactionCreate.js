    ...
    execute: async (client, interaction) => {
        if (interaction.isCommand()) {
            ...
            if (commandFile) {
                ...
                console.log(client.timeLog, `\x1b[32m${interaction.user.tag}\x1b[36m used \x1b[32m/${interaction.commandName} ${interaction.options._subcommand ?? ''}\x1b[36m in \x1b[32m#${interaction.channel.name}`);
                try {
