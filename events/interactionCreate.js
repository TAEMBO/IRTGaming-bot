    ...
    execute: async (client, interaction) => {
        if (interaction.isButton()) {
            ...
            if (commandFile) {
                ...
                console.log(`\x1b[36m[${moment().format('HH:mm:ss')}] \x1b[33m${interaction.user.tag}\x1b[36m used \x1b[33m/${interaction.commandName} ${interaction.options._subcommand ?? ''}\x1b[36m in \x1b[33m#${interaction.channel.name}`);
                try {
