...
export default new Command<"chatInput">({
    async run(interaction) {
        ...
        const answers = [
            "Without a doubt. Nah, I'm just messing with you",
            "My sources say no",
            ...
            "Outlook not so good",
            "Very doubtful",
            "My dad said I cant answer that, try again later",
            "*yawn*",
            "Provided that you say 'Thank you'",
            ...
            "Now you can",
            "Act asthough it is already real",
    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(x => x.setName("question").setDescription("Your closed-ended question").setRequired(true)),
});
