...
export default new Command<"chatInput">({
    ...
    data: new SlashCommandBuilder()
        ...
        .addUserOption(x => x.setName("member").setDescription("The member to bonk").setRequired(true))
        .addStringOption(x => x.setName("reason").setDescription("The reason for bonking the member").setRequired(false)),
});
