...
export default new Command<"message">({
    async run(interaction) {
        ...
        if (
            ...
            return await interaction.reply({
                content: "You need to select a message that is a community idea!",
                ephemeral: true,
            });
    ...
    data: new ContextMenuCommandBuilder().setName("Mark Suggestion").setType(ApplicationCommandType.Message),
});
