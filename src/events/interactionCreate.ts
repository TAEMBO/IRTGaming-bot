...
export default async (interaction: Interaction) => {
    ...
    if (interaction.isChatInputCommand()) {
        ...
        if (!interaction.client.config.botSwitches.commands && !interaction.client.config.devWhitelist.includes(interaction.user.id)) return await interaction.reply('Commands are currently disabled.');
